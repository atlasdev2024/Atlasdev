...
const Hero = ({ onBookNowClick }) => {
  ...
  return (
    <div className="hero-container bg-slate-700 relative">
              ...
              <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
                <div className="bg-gray-200 p-6 rounded-lg shadow-md w-full max-w-md pr-10">
                  <form ref={formRef} onSubmit={sendEmail}>
                    ...
                    <input type="text" name="prefered_date" className="block w-full border border-gray-300 rounded-md p-2 mb-4" />
